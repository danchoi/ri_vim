...
task :bump do
  basefile = "lib/ri_vim/version.rb"
...
task :web => :build_webpage do
  ...
  Dir.chdir "../project-webpages" do
    `scp out/ri_vim.html zoe2@instantwatcher.com:~/danielchoi.com/public/software/`
    `rsync -avz out/images-ri_vim zoe2@instantwatcher.com:~/danielchoi.com/public/software/`
  ...
  #`open http://danielchoi.com/software/ri_vim.html`
end
